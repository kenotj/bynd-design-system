  ...
  return (
    <div className="flex flex-col justify-center min-h-screen px-12 py-32 max-w-5xl mx-auto">
      <FadeIn className="mb-24">
        ...
        <h2 className="font-serif text-5xl md:text-7xl text-[#1f1d1a] leading-[1.05] tracking-tight max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-24">
        <div className="flex flex-col">
          <FadeIn delay={0.2}>
            <div className="aspect-[4/3] rounded-3xl overflow-hidden mb-10 bg-[#F5F1E8]">
              <img src={imgMinimalInterior} alt="Minimal Interior" className="w-full h-full object-cover" />
            </div>
            <h3 className="font-serif text-4xl text-[#1f1d1a] mb-4">Warm Editorial Minimalism</h3>
        ...
        <div className="flex flex-col md:mt-24">
          <FadeIn delay={0.4}>
            <div className="aspect-[3/4] rounded-3xl overflow-hidden mb-10 bg-[#F5F1E8]">
              <img src={imgPremiumWhitespace} alt="Premium Whitespace" className="w-full h-full object-cover" />
            </div>
            <h3 className="font-serif text-4xl text-[#1f1d1a] mb-4">Visual-first Storytelling</h3>
            <p className="font-sans text-[#8b8478] leading-relaxed text-lg font-light">
