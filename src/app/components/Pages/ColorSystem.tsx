  ...
  return (
    <div className="flex flex-col justify-center min-h-screen px-12 py-32 max-w-5xl mx-auto">
      <FadeIn className="mb-20 max-w-2xl">
        <h2 className="font-serif text-5xl md:text-6xl text-[#1f1d1a] mb-6 tracking-tight">Color Palette</h2>
      ...
      <div className="mt-32 grid grid-cols-1 md:grid-cols-2 gap-12">
        <FadeIn delay={0.2} className="bg-[#F5F1E8] p-16 rounded-3xl flex flex-col justify-center items-start border border-[#D9D1C5]/50 hover:bg-[#FBF9F4] transition-colors duration-500">
          <p className="font-sans text-xs uppercase tracking-[2px] text-[#8b8478] mb-8 font-semibold">Primary Usage</p>
          <h3 className="font-serif text-4xl text-[#1f1d1a] mb-6 leading-tight">Paper & Ink</h3>
        ...
        <FadeIn delay={0.4} className="bg-[#6F7B5E] p-16 rounded-3xl flex flex-col justify-center items-start text-[#FBF9F4] relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#FBF9F4] opacity-5 rounded-full blur-3xl translate-x-1/3 -translate-y-1/3" />
          <p className="font-sans text-xs uppercase tracking-[2px] text-[#D9D1C5] mb-8 font-semibold relative z-10">Accent Usage</p>
          <h3 className="font-serif text-4xl mb-6 leading-tight relative z-10">Olive Sage</h3>
