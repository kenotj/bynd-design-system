      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <FadeIn delay={0.2} className="space-y-12">
          <div>
            ...
            <div className="flex flex-wrap gap-4 items-center p-8 bg-white border border-[#D9D1C5] rounded-3xl">
              <button className="px-6 py-3 bg-[#1F1D1A] text-white rounded-full font-sans text-[13px] hover:bg-[#6F7B5E] transition-colors duration-300 flex items-center gap-2">
                Primary Button <ArrowRight size={14} />
              </button>

              <button className="px-6 py-3 bg-transparent border border-[#D9D1C5] text-[#1F1D1A] rounded-full font-sans text-[13px] hover:bg-[#F5F1E8] transition-colors duration-300">
                Secondary Button
              </button>
          ...
          <div>
            ...
            <div className="flex flex-col gap-6 p-8 bg-white border border-[#D9D1C5] rounded-3xl items-start">
              <a className="font-sans text-[14px] text-[#1F1D1A] border-b border-[#1F1D1A] pb-[2px] hover:text-[#6F7B5E] hover:border-[#6F7B5E] transition-colors duration-300 inline-flex items-center gap-2 cursor-default">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3 p-8 bg-white border border-[#D9D1C5] rounded-3xl">
        ...
        <FadeIn delay={0.4} className="space-y-12">
          <div>
            ...
            <div className="flex flex-col gap-6 p-8 bg-white border border-[#D9D1C5] rounded-3xl">
          ...
          <div>
            ...
            <div className="p-8 bg-[#F5F1E8] border border-[#D9D1C5] border-opacity-50 rounded-3xl flex items-center justify-center">
